...
Script to generate test-retest reliability (relative repeatability) of a measurement using the intraclass correlation coefficient (ICC) ([Rajaratnam, 1960](https://doi.org/10.1007/BF02289730)). The UCLA repeated measures exercise dataset ([UCLA Office of Advanced Research Computing, n.d.](https://stats.oarc.ucla.edu/r/seminars/repeated-measures-analysis-with-r/)) is used for demonstration. The two-way random effects, absolute agreement, and single measurement convention is used ([McGraw et al, 1996](https://psycnet.apa.org/record/1996-03170-003); [Koo et al, 2016](https://doi.org/10.1016/j.jcm.2016.02.012)). Accordingly, the ICC is obtained through the following equation,
